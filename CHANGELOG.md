...
| --------- | ---------------- | ----------- |
| antiSMASH | 7.1.0            | 8.0.0       |

### `Deprecated`

- [#???](https://github.com/nf-core/funcscan/pull/???) - removed `--bgc_antismash_installdir` as new antiSMASH module container no longer requires mounting of this directory for execution. (by @mberacochea and @jfy133)
